...
// 获取key的方法
function getKeysFunc(isFull: boolean) {
	...
	// 判断是否是合法的类数组的index
	function isIndex(value: any, length: null | number) {
...
function cloneArguments(args: any) {
...
const cloneDeep = function (target: any, isFull: boolean = true, cache: any = new WeakMap(), parent: any = undefined) {
	// 值类型
